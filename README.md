...
python3 -m unittest -v pypodo/__pypodo__test.py #to execute unit tests : report in test.log
coverage run && coverage html #to generate html : report in htmlcov folder
mutatest #to test mutations #to generate mutations : report in mutation.log
pylint pypodo/__pypodo__.py #to evaluate quality of code unit tests : report in pylint.log
```
###  Local CI/CD
